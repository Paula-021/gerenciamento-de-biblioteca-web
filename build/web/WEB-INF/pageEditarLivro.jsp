...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form class="form-group" action="editar-livro" method="POST"> 
                <input value="${livro.id}" name="id" hidden>
                <input class="form-control" value="${livro.titulo}" placeholder="Digite o título" name="titulo" required>
                <input class="form-control" value="${livro.autor}" placeholder="Digite o autor" name="autor" required>
                <input class="form-control" value="${livro.genero}" placeholder="Digite o genero" name="genero" required>
                <input class="form-control" value="${livro.isbn}" placeholder="Digite o isbn" name="isbn" required>
